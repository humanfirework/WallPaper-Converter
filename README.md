...
1. **克隆或下载项目**
```bash
git clone https://github.com/humanfirework/WallPaper-Converter.git
...
**Q: NCM 文件转换失败？**
A: 请确保已安装 ncmdump 库（requirements.txt 中已包含）。如有问题，请检查 NCM 文件是否完整。
